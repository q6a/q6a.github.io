function debounce(func,wait,immediate){var timeout;return function(){var context=this,args=arguments;var later=function(){timeout=null;if(!immediate)func.apply(context,args);};var callNow=immediate&&!timeout;clearTimeout(timeout);timeout=setTimeout(later,wait);if(callNow)func.apply(context,args);};};"use strict";window.config=window.config||{};window.config.useLocalApp=true;$(document).ready(function(){var btnFTStart=$("#freeTrialButton");var btnFTSubmit=$("#signupSubmit");var inputFTEmail=$("#emailSub");var inputFTLegalAccept=$("#legalinfoch");var appDisabled=btnFTStart.hasClass("appDisabled");btnFTSubmit.attr("disabled","disabled");var modalLanguages=$("#confirm-language");var modalLegal=$("#legalModal");var btnFreeTrialHome=$(".btn-free-trial-home");function isEmail(str){var re=/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/;return!!str.match(re);}
...
btnFreeTrialHome.click(handleBtnFreeTrialHome);function getSelectedSecondaryLanguages(){var inputsLanguages=modalLanguages.find("input[type=checkbox]:checked");var results=[];inputsLanguages.each(function(){if(this.name==="legalinfo"){return;}
