...
btnFTSubmit.click(handleFTSubmitClick);});$("#search-query").keypress(function(event){var keycode=event.keyCode?event.keyCode:event.which;if(keycode=="13"){handleBtnSearchPopup();}});function handleBtnSearchPopup(e){(function(i,s,o,g,r,a,m){i["GoogleAnalyticsObject"]=r;(i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments);}),(i[r].l=1*new Date());(a=s.createElement(o)),(m=s.getElementsByTagName(o)[0]);a.async=1;a.src=g;m.parentNode.insertBefore(a,m);})(window,document,"script","https://www.google-analytics.com/analytics.js","ga");ga("create","UA-115780836-2","auto");ga("send","Search page view");$("#search-results").empty();searchQuery=$("#search-query").val();if(searchQuery){ga("send","event","search category","search","search",searchQuery,"search");$("#search-query").val(searchQuery);executeSearch(searchQuery);}else{$("#search-results").append("<p>Please enter a word or phrase above !</p>");}}
